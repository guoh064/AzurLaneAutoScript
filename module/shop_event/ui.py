...
OCR_EVENT_SHOP_DEADLINE = Ocr(SHOP_OCR_EVENT_DEADLINE, lang='cnocr', letter=(96, 162, 62),
                              alphabet='0123456789.:~-', name="OCR_EVENT_SHOP_DEADLINE")
if server.server == 'jp':
    OCR_EVENT_SHOP_PT = Digit(SHOP_OCR_BALANCE, letter=(110, 120, 130), name='OCR_EVENT_SHOP_PT')
    OCR_EVENT_SHOP_URPT = Digit(SHOP_OCR_BALANCE_SECOND, letter=(110, 120, 130), name='OCR_EVENT_SHOP_URPT')
else:
