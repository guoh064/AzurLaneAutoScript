...
class Retirement(Enhancement, QuickRetireSettingHandler):
    ...
    def _retire_confirm_scroll_appear(self, skip_first_screenshot=True):
        """
        Returns:
        ...
        while 1:
            ...
            if RETIRE_CONFIRM_SCROLL.appear(main=self):
                ...
                logger.warning('RETIRE_CONFIRM_SCROLL disappeared')
            if timeout.reached():
                logger.warning('RETIRE_CONFIRM_SCROLL disappeared confirm')
                return False
